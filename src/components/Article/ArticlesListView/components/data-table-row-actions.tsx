...
import { LivePreviewScheduleDialog } from './LivePreviewDialog'
      ...
      fields={[
        {
          type: 'date',
          name: 'published',
          //label: t(toTranslationKey('published') as any),
        },
        {
          type: 'relationship',
          name: 'assignee',
          //label: t(toTranslationKey('assignee') as any),
          relationTo: 'users',
        },
        {
          type: 'select',
          name: 'status',
          //label: t(toTranslationKey('status') as any),
