...
import { Gallery, Show } from '@/payload-types'
import { GETPaginatedDocs } from '@/utils/fetchDoc'
import { useState } from 'react'
import { columns } from './components/columns'
import { ShowFilter } from './components/data-table-custom-filter'
...
export const ShowDatatable = () => {
  ...
  return (
    <DataTable
      ...
      filterComponent={({ setFilters }) => <ShowFilter setFilters={setFilters} />}
    />
  )
}
