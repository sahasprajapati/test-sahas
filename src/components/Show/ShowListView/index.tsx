...
export default async function ShowListView(arg: any) {
      ...
      <div className="  flex-1 flex-col space-y-8 p-8 md:flex text-base">
        <div className="flex items-center justify-between space-y-2">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-6xl font-bold tracking-tight p-0 py-2 m-0">{t('custom:show')}</h2>

            <Link href={'/admin/collections/show/create'}>
